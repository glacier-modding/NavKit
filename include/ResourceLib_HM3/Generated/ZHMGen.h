...
public:
	...
	bool operator!=(const AI_Private_Details_SBaseStimulus_Pool_SaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_Private_Details_SStimulus_AgentData_SaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_Private_SPoolSnapshot& p_Other) const { return !(*this == p_Other); }

	ZString StimulusTypeName; // 0x0
	uint32 StimulusTypeId; // 0x10
	uint32 PoolSize; // 0x14
	TArray<AI_Private_SStimulusSnapshot> Stimuli; // 0x18
};
...
public:
	...
	bool operator!=(const AI_Private_SFullDataSnapshotEvent& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_Private_SPoolModificationEvent& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_Private_SPoolModificationCollectionEvent& p_Other) const { return !(*this == p_Other); }

	TArray<AI_Private_SPoolModificationEvent> PoolModificationEvents; // 0x0
};
...
public:
	...
	bool operator!=(const AI_SEventDescription& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_SFirePattern01_SData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_SFirePattern01& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_SFirePattern02_SData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_SFirePattern02& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const AI_SSoundEventModifierState& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x4
enum class EEvergreenMenuLabelPurpose
{
	NONE = 0,
	ACTION_KILL_TYPE = 1,
	POISON_LETHAL = 2,
...
enum class ERequirementId
{
	...
	EREQUIREMENT_H3_VANITY_CONCRETEART = 43,
...
// Size: 0x4
enum class ESoundCollisionFlags
{
...
// Size: 0x1
enum class ESubtitleSpeakerIndicatorType
{
	DEFAULT = 0,
	NO_INDICATOR = 1,
	INWORLD_BUBBLE = 2,
...
// Size: 0x4
enum class EUIOpenVRComponentArchetypeID
{
	ButtonL = 1,
	ButtonR = 2,
	Button = 3,
...
// Size: 0x4
enum class EUIOpenVRPressDirection
{
	North = 1,
	South = 2,
	East = 4,
...
// Size: 0x4
enum class EVRConfig360CameraAnchor
{
...
public:
	...
	bool operator!=(const IContractObjective_SCounterData& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x4
enum class IEvergreenTerritoryStatus_EVisited
{
	NotVisited = 0,
	VisitedAndWon = 1,
	VisitedAndLost = 2,
...
enum class JSONTemplate_ETemplateType
{
	...
	ETT_STOREREGION = 39,
	ETT_STORE = 40,
	ETT_IS_DISC_RELEASE = 41,
	ETT_ISDEBUG = 42,
	ETT_INPUTCONTROLLERTYPE = 43,
	ETT_IS_CONTROLLER_AVAILABLE = 44,
	ETT_IS_KEYBOARD_AVAILABLE = 45,
	ETT_IS_VR_DEVICE_AVAILABLE = 46,
	ETT_IS_VR_DEVICE_ACTIVE = 47,
	ETT_IS_VR_ACTIVE = 48,
	ETT_VR_MODE = 49,
	ETT_TEMPLATES_OVERRIDE_BEGIN = 50,
	ETT_ONLINE_RESOURCE = 50,
	ETT_INCLUDE = 51,
	ETT_UI_OPTION_VALUE = 52,
	ETT_UI_OPTION_DEFAULT_VALUE = 53,
	ETT_UI_OPTION_DEBUG_VALUE = 54,
	ETT_UI_OPTION_AVAILABLE = 55,
	ETT_UI_OPTION_AVAILABLE_DISPLAY_RESOLUTIONS = 56,
	ETT_UI_OPTION_AVAILABLE_DISPLAY_FULLSCREEN = 57,
	ETT_UI_OPTION_AVAILABLE_MOTION_BLUR = 58,
	ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY = 59,
	ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY = 60,
	ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING = 61,
	ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE = 62,
	ETT_UI_OPTION_AVAILABLE_VRS = 63,
	ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION = 64,
	ETT_CURRENT_CONTRACT_CONTEXT = 65,
	ETT_CURRENT_CONTRACT_OBJECTIVES = 66,
	ETT_CURRENT_CONTRACT_SESSIONID = 67,
	ETT_CURRENT_CONTRACT_CHARACTER_INFO = 68,
	ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY = 69,
	ETT_CURRENT_DIFFICULTY = 70,
	ETT_CURRENT_ENGINE_MODE = 71,
	ETT_CURRENT_GAME_MODE = 72,
	ETT_CAN_SAVE = 73,
	ETT_IS_SAVELIMIT_EXCEEDED = 74,
	ETT_IS_ALLOWED_TO_RESTART = 75,
	ETT_ACTIVE_CHALLENGES = 76,
	ETT_USER = 77,
	ETT_ISUSER = 78,
	ETT_DLCCOUNT = 79,
	ETT_PROFILEID = 80,
	ETT_HDRGAMMAVALUERANGEMIN = 81,
	ETT_HDRGAMMAVALUERANGEMAX = 82,
	ETT_HDRGAMMAVALUESTEP = 83,
	ETT_ISDLSSAVAILABLE = 84,
	ETT_ISXESSAVAILABLE = 85,
	ETT_ISXESSINSTALLED = 86,
	ETT_ISHDRAVAILABLE = 87,
	ETT_ISHDRRENDERING = 88,
	ETT_ISRAYTRACINGAVAILABLE = 89,
	ETT_VARIABLERATESHADINGTIER = 90,
	ETT_ITEM = 91,
	ETT_REPOSITORY = 92,
	ETT_ISONLINE = 93,
	ETT_ISINGAME = 94,
	ETT_ISINEDITOR = 95,
	ETT_ISUGCRESTRICTED = 96,
	ETT_ISPACKAGEOWNED = 97,
	ETT_ISININVENTORY = 98,
	ETT_ISPLATFORMENTITLEMENTOWNED = 99,
	ETT_MULTIPLAYERLOBBYSTATE = 100,
	ETT_MULTIPLAYERLOCALID = 101,
	ETT_MULTIPLAYERJOINEDIDS = 102,
	ETT_MULTIPLAYERISPLAYERREADY = 103,
	ETT_MULTIPLAYERINFO = 104,
	ETT_MULTIPLAYERMATCHMAKINGTIME = 105,
	ETT_MULTIPLAYERNATTYPE = 106,
	ETT_LOADOUT = 107,
	ETT_LOADOUT_SLOT = 108,
	ETT_LOADOUT_AGENCY_PICKUP = 109,
	ETT_LOADOUT_SELECTED_ENTRANCE = 110,
	ETT_PERSISTENTMENUDATA = 111,
	ETT_GAMEPERSISTENTDATA = 112,
	ETT_ENDGAME_PAGETRANSITION_OVERRIDE = 113,
	ETT_VERSUSINFO = 114,
	ETT_SNIPERINFO = 115,
	ETT_GAMEMODE = 116,
	ETT_CACHEDUSERCENTRICCONTRACT = 117,
	ETT_SAVEGAMES = 118,
	ETT_AVAILABILITY_OF_RESOURCES = 119,
	ETT_AVAILABILITY_OF_CONTRACT = 120,
	ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT = 121,
	ETT_AS3DATE = 122,
	ETT_IOIACCOUNT_STATUS = 123,
	ETT_ISCONTRACT_IN_PLAYLIST = 124,
	ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION = 125,
	ETT_VIDEOMEMORYINFO_IS_SUPPORTED = 126,
	ETT_VIDEOMEMORYINFO = 127,
	ETT_DISPLAY_SIZE = 128,
	ETT_IS_VIDEO_VALID = 129,
	ETT_INTEL_IDS = 130,
	ETT_INTEL_DETAILS = 131,
	ETT_MENU_CONFIGURATION = 132,
	ETT_HERO_INVENTORY = 133,
	ETT_MAP_TRACKERINFO = 134,
	ETT_WAS_EXITGATE_TRIGGERED = 135,
	ETT_ARE_OPPORTUNITIES_ENABLED = 136,
	ETT_CHARACTERS = 137,
	ETT_CHARACTERINFO = 138,
	ETT_DATABINDING = 139,
	ETT_DATABINDING_ROOT = 140,
	ETT_ALLOWED_UNLOCKABLES = 141,
	ETT_HAS_FRAMERATE_OPTION = 142,
	ETT_MENU_DATAPROVIDER = 143,
	ETT_INTERACTIONINDICATOR = 144,
	ETT_NVIDIAHIGHLIGHTSAVAILABLE = 145,
	ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS = 146,
	ETT_DEBUG_ALLHITMANSUITS = 147,
};
...
public:
	...
	bool operator!=(const S25DProjectionSettingsCurveEntry& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SWorldSpaceSettings& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool enableWorldSizeScaling; // 0x20
	uint8_t _pad21[3] {};
	float32 fWorldSizeScalingBaseDistance; // 0x24
	float32 fWorldSizeScalingFactorMax; // 0x28
	float32 fWorldSizeScalingFactorMin; // 0x2C
	float32 fScaleFactor; // 0x30
	float32 fNearAlpha; // 0x34
	float32 fFarAlpha; // 0x38
	float32 fAlphaFactor; // 0x3C
	TArray<S25DProjectionSettingsCurveEntry> aScaleCurve; // 0x40
	TArray<S25DProjectionSettingsCurveEntry> aAlphaCurve; // 0x58
...
public:
	...
	bool operator!=(const SActivity& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActivityExits& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActivityObjective& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActivityDefinition& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActivities& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActorAliveConditionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActorAnimSetVariationIndexSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActorIKControllerSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SActorVisibilityConditionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SAimAssistObjectSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SAudioMemoryMonitorEntry& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SCCEffectSet& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool m_bLockdownGracePeriod; // 0x5B
	bool m_bHMInGuardDisguise; // 0x5C
	bool m_bFrisked; // 0x5D
	bool m_bAnnouncedFrisk; // 0x5E
	bool m_bReasonToFrisk; // 0x5F
...
public:
	...
	int32 m_pGetHelpGroup; // 0x78
	int32 m_pBackupGroup; // 0x7C
	int32 m_rTriggerAlarmGroup; // 0x80
	int32 m_pInvestigateDisguiseGroup; // 0x84
	TArray<int32> m_cautiousVIPGroups; // 0x88
	TArray<int32> m_friskGroups; // 0xA0
	ZGameTime m_tFriskCooldown; // 0xB8
	ZGameTime m_tFriskGroupEnd; // 0xC0
	ZGameTime m_tRecoverUnconsciousGroupEnd; // 0xC8
	int32 m_nHuntTarget; // 0xD0
	uint32 m_rZone; // 0xD4
	...
	ZGameTime m_tLastIdleStanddown; // 0x188
	TArray<int32> m_aAvoidDangerGroups; // 0x190
	SCautiousHuntSaveData m_cautiousHuntData; // 0x1A8
};
...
public:
	...
	bool operator!=(const SComboDeviceBinding& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SContainerItemInfo& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SConversationEntry& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SRunningCrowdAIEventSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SCrowdAIEventSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDestructibleInteractionHandlerData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDestructiblePieceSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDrama2ActorSaveState& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDrama2ActorCollectionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDrama2SetupCollectionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDrama2SituationSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDrama2SituationCollectionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SDramaControllerSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SEntityTemplateExposedEntity& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SEntityTemplatePlatformSpecificProperty& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SEscortSituation2ActorStateSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SEscortSituation2Actors& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SEscortSituation2SaveData& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x18
class /*alignas(8)*/ SEvergreenMenuCursorDecorationData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SEvergreenMenuCursorDecorationData& p_Other) const;
	bool operator!=(const SEvergreenMenuCursorDecorationData& p_Other) const { return !(*this == p_Other); }

	ZString icon; // 0x0
	bool isIconCutOut; // 0x10
	bool isIconFramed; // 0x11
	uint8_t _pad12[6] {};
};

// Size: 0x18
class /*alignas(8)*/ SEvergreenMenuLabelData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SEvergreenMenuLabelData& p_Other) const;
	bool operator!=(const SEvergreenMenuLabelData& p_Other) const { return !(*this == p_Other); }

	EEvergreenMenuLabelPurpose purpose; // 0x0
	uint8_t _pad4[4] {};
	ZString lstrTitle; // 0x8
};

// Size: 0x70
class /*alignas(8)*/ SEvergreenMenuHeadlineData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SEvergreenMenuHeadlineData& p_Other) const;
	bool operator!=(const SEvergreenMenuHeadlineData& p_Other) const { return !(*this == p_Other); }

	ZString lstrMicroMessage; // 0x0
	ZString icon; // 0x10
	ZString lstrTitle; // 0x20
	ZString lstrHeader; // 0x30
	TArray<ZString> microicons; // 0x40
	TArray<SEvergreenMenuLabelData> labels; // 0x58
};

// Size: 0x38
class /*alignas(8)*/ SEvergreenMenuPerkData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SEvergreenMenuPerkData& p_Other) const;
	bool operator!=(const SEvergreenMenuPerkData& p_Other) const { return !(*this == p_Other); }

	ZString icon; // 0x0
	ZString lstrTitle; // 0x10
	ZString lstrDescription; // 0x20
	EEvergreenMenuLabelPurpose purposeColorTint; // 0x30
	uint8_t _pad34[4] {};
};

// Size: 0x70
class /*alignas(8)*/ SEvergreenMenuInfoPanelRData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SEvergreenMenuInfoPanelRData& p_Other) const;
	bool operator!=(const SEvergreenMenuInfoPanelRData& p_Other) const { return !(*this == p_Other); }

	ZString icon; // 0x0
	ZString lstrTitle; // 0x10
	ZString lstrHeader; // 0x20
	ZString lstrDescription; // 0x30
	TArray<SEvergreenMenuPerkData> perks; // 0x40
	TArray<SEvergreenMenuLabelData> labels; // 0x58
};
...
public:
	...
	bool operator==(const SEvergreenMenuPromptDesc& p_Other) const;
	bool operator!=(const SEvergreenMenuPromptDesc& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExitsActiveSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExposedEntityTypeDescriptor& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const STypeReference& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExposedTypeInfo& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExtendedCppEntityProperty& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExtendedCppEntityBlueprint& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SExternalEntityTemplatePinConnection& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SGUIViewPort& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SGaitTransitionEntry& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SGeomScaleSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SGetIActorPositionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHUDPIPControllerSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHandleDistractionSituationSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHeroCameraStandInSaveState& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHeroEscortSituation2ActorStateSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHeroEscortSituation2Actors& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SHeroEscortSituation2SaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SInteractionIndicatorInstanceData_SUIControlData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SInventoryControllerSlotSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	uint32 m_nAmmoCountDartEmetic; // 0x84
	uint32 m_nAmmoCountAmmoShotgunBeanbag; // 0x88
	uint8_t _pad8C[4] {};
	TArray<ZRepositoryID> m_aAmmoIds; // 0x90
...
public:
	...
	bool operator!=(const SInventoryMovementConfig& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SInventoryUISlotSlim& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x4
enum class eEvergreenItemRarity
{
	SAFEHOUSEONLY = -1,
	NONE = 0,
	COMMON = 1,
...
public:
	...
	eEvergreenItemRarity evergreenRarity; // 0x100
	bool evergreenLoseOnWounded; // 0x104
	uint8_t _pad105[3] {};
};
...
public:
	...
	bool operator!=(const SInventoryUICache& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SItemActionSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SItemLeftHandUIData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SMathDistanceSaveData_SVector2& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SMathDistanceSaveData_SVector3& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SMathDistanceSaveData_SVector4& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SPIPMessageManagerProxySaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SProgressTimerEntitySaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SRememberActorSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SSCCuriousConfiguration& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SScreenplay2ManagerSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SScreenplayRole2HeroSaveState& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SSniperScoringEvent& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SStateControllerSaveDataStruct& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const STargetableBoneConfiguration& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const STemplateBlueprintSubEntity& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const STemplateFactorySubEntity& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const STemplateEntityFactory& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SUIBreadcrumbDataSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SUIOpenVRComponent& p_Other) const { return !(*this == p_Other); }

	EUIOpenVRComponentArchetypeID idArchetype; // 0x0
	EUIOpenVRPressDirection direction; // 0x4
	ZString label; // 0x8
};
...
public:
	...
	TArray<uint32> mappings; // 0x30
	TArray<ZString> cbMappingNames; // 0x48
	TArray<TArray<SComboDeviceBinding>> cbMappings; // 0x60
};
...
public:
	...
	bool operator!=(const SVRConfigCameraComponent& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SValueBoolDelayedEntitySaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SWeaponCustomControlSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const SZHUDIgnoreVisibilitySaveData& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x4
enum class String_Comperator_Poll_EEvaluationType
{
	EQUAL = 0,
	NOT_EQUAL = 1,
	LESS = 2,
...
// Size: 0x4
enum class ZCameraPlaneAlignedTriggerEntity_EAlignment
{
	X_POSITIVE = 0,
	Y_POSITIVE = 1,
	Z_POSITIVE = 2,
...
public:
	...
	int32 nDifficultyRank; // 0x38
	int32 mercesDeposit; // 0x3C
...
// Size: 0x4
enum class ZEvergreenCampaignDefinitionPollInt_EQuery
{
	DifficultyRank = 0,
	Deposit = 1,
	PayoutBase = 2,
...
// Size: 0x4
enum class ZEvergreenCampaignStatusPollInt_EQuery
{
	DifficultyRank = 0,
	Deposit = 1,
	PayoutBase = 2,
...
// Size: 0x4
enum class ZEvergreenCampaignStatusPollString_EQuery
{
	LeaderCodename = 0,
	Biography = 1,
};
...
// Size: 0x4
enum class ZEvergreenGearWallMenuEntryAddOn_EItemRarity
{
	SAFEHOUSEONLY = -1,
	NONE = 0,
	COMMON = 1,
...
// Size: 0x4
enum class ZEvergreenLocationIntelDataProvider_EVisited
{
	NotVisited = 0,
	VisitedAndWon = 1,
	VisitedAndLost = 2,
...
// Size: 0x10
class /*alignas(4)*/ ZEvergreenLocationIntelDataProvider_SData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZEvergreenLocationIntelDataProvider_SData& p_Other) const;
	bool operator!=(const ZEvergreenLocationIntelDataProvider_SData& p_Other) const { return !(*this == p_Other); }

	int32 nSuppliers; // 0x0
	int32 nMules; // 0x4
	int32 nSafes; // 0x8
	int32 nTargets; // 0xC
};
...
// Size: 0x4
enum class ZEvergreenMenuCondition_EQuery
{
	IS_OPENING = 0,
	IS_OPEN = 1,
...
// Size: 0x18
class /*alignas(8)*/ ZEvergreenMenuController_SPromptsData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZEvergreenMenuController_SPromptsData& p_Other) const;
	bool operator!=(const ZEvergreenMenuController_SPromptsData& p_Other) const { return !(*this == p_Other); }

	TArray<SEvergreenMenuPromptDesc> buttonprompts; // 0x0
};
...
// Size: 0x4
enum class ZEvergreenMenuEntryEntity_ECursorShape
{
	AUTO = 0,
	FLAT = 1,
	CYLINDER = 2,
...
// Size: 0x4
enum class ZEvergreenMenuEntryPromptButtonAction_EInputTrigger
{
	ACCEPT = 0,
	CANCEL = 1,
	ACTION_X = 2,
...
// Size: 0x30
class /*alignas(8)*/ ZEvergreenPrestigeObjectiveInfoDataProvider_SPrestigeInfo
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZEvergreenPrestigeObjectiveInfoDataProvider_SPrestigeInfo& p_Other) const;
	bool operator!=(const ZEvergreenPrestigeObjectiveInfoDataProvider_SPrestigeInfo& p_Other) const { return !(*this == p_Other); }

	ZString title; // 0x0
	ZString description; // 0x10
	ZString image; // 0x20
};
...
public:
	...
	bool isPrestigeObjectiveActive; // 0x5
};
...
// Size: 0x4
enum class ZEvergreenWorldMapTerritoryDataProvider_EVisited
{
	NotVisited = 0,
	VisitedAndWon = 1,
	VisitedAndLost = 2,
...
// Size: 0x70
class /*alignas(8)*/ ZEvergreenWorldMapTerritoryDataProvider_SData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZEvergreenWorldMapTerritoryDataProvider_SData& p_Other) const;
	bool operator!=(const ZEvergreenWorldMapTerritoryDataProvider_SData& p_Other) const { return !(*this == p_Other); }

	bool isInCampaign; // 0x0
	bool isSelectedInMenu; // 0x1
	bool isMenuZoomedIn; // 0x2
	uint8_t _pad3[5] {};
	ZString lstrDestinationCity; // 0x8
	ZString lstrDestinationCountry; // 0x18
	ZString lstrDestinationFullName; // 0x28
	int32 mercesPayout; // 0x38
	int32 nSuppliers; // 0x3C
	int32 nMules; // 0x40
	int32 nSafes; // 0x44
	int32 nTargets; // 0x48
	bool isAlerted; // 0x4C
	uint8_t _pad4D[3] {};
	ZEvergreenWorldMapTerritoryDataProvider_EVisited visited; // 0x50
	bool isHotMission; // 0x54
...
public:
	...
	bool operator!=(const ZHUDCamera3DControllerEntity_SEyeToPlane& p_Other) const { return !(*this == p_Other); }

	float4 posCharacter; // 0x0
	float4 udirTowardsPlane; // 0x10
	float4 udirAnchor; // 0x20
};
...
public:
	...
	bool operator!=(const ZHUDInventoryNotificationController_SData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZHUDOccluderTriggerEntity_SBoneTestSetup& p_Other) const { return !(*this == p_Other); }

	BoneId_Enum boneId; // 0x0
	SVector3 localOffset; // 0x4
	float32 radius; // 0x10
};
...
public:
	...
	ZString groupId; // 0x0
	ZString intelHeadline; // 0x10
	ZRepositoryID repoID; // 0x20
	int32 intelType; // 0x30
	float32 showDuration; // 0x34
};
...
// Size: 0x18
class /*alignas(8)*/ ZHUDWalkSpeedDataProvider_SData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteSimpleJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZHUDWalkSpeedDataProvider_SData& p_Other) const;
	bool operator!=(const ZHUDWalkSpeedDataProvider_SData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZInfectedSituation_SSituationSaveData& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZKeywordCalculator_SCollection& p_Other) const { return !(*this == p_Other); }
...
// Size: 0x4
enum class ZMinimapDirectionProvider_EAxis
{
	X_POSITIVE = 0,
	X_NEGATIVE = 1,
	Y_POSITIVE = 2,
...
// Size: 0x4
enum class ZMinimapDirectionProvider_EProviderType
{
	NAVIGATION = 0,
	HERO_MARKER = 1,
};
...
public:
	...
	bool operator!=(const ZPhotoModeMenuDataProvider_SPrompt& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZPhotoModeMenuDataProvider_SMenuEntry& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZRuntimePinConDesc& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZScopedRuntimePinConDesc& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	uint32 m_TargetWeaponItem; // 0x88
	uint32 m_IllegalWeaponSeen; // 0x8C
	int32 m_pGetHelpGroup; // 0x90
...
// Size: 0x4
enum class ZSubtitleSpeakerAliasEntity_EApplicabilityBit
{
	Realtime = 1,
	PreRendered = 2,
};
...
public:
	...
	int32 nAmmoTotal; // 0x44
	int32 nAmmoInClip; // 0x48
	int32 nWeaponType; // 0x4C
	ZString itemCategory; // 0x50
	ZString itemCategoryLKey; // 0x60
	ZString inventoryCategoryIcon; // 0x70
...
public:
	...
	bool operator!=(const ZUIActionSelectorNavigationInventoryEntity_SActionSelectorDataCache& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZUIActionSelectorNavigationInventoryEntity_SActionSelectorSlotDisplayInfoSlim& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	TArray<ZUIActionSelectorNavigationInventoryEntity_SActionSelectorSlotDisplayInfoSlim> mainslotsSlim; // 0x0
	int32 otherslotsCount; // 0x18
	int32 selectedIndex; // 0x1C
	bool isActionInventory; // 0x20
	uint8_t _pad21[7] {};
...
// Size: 0x1
enum class ZUIControlPositionLayoutFlowListAspect_EFlowMode
{
	Fill = 0,
	Fit = 1,
};
...
// Size: 0x1
enum class ZUIControlPositionLayoutListBaseAspect_EDirection
{
	Vertical = 0,
	Horizontal = 1,
	VerticalReversed = 2,
...
// Size: 0x1
enum class ZUIControlPositionLayoutListBaseAspect_EItemSizeMode
{
	BiggestChild = 0,
	Fit = 1,
	Override = 2,
...
// Size: 0x1
enum class ZUIControlSizeLayoutScaleboxAspect_EContentSizeMode
{
	BiggestChild = 0,
	ChildBoundingBox = 1,
	Override = 2,
...
// Size: 0x1
enum class ZUIControlSizeLayoutScaleboxAspect_EScaleboxMode
{
	Fill = 0,
	Fit = 1,
	FitX = 2,
...
public:
	...
	bool operator!=(const ZUIEmoteSelectorNavigationEntity_SActionSelectorSlotDisplayInfo& p_Other) const { return !(*this == p_Other); }
	...
	int32 nAmmoTotal; // 0x54
	int32 nAmmoInClip; // 0x58
	int32 nWeaponType; // 0x5C
	ZString itemCategory; // 0x60
	ZString itemCategoryLKey; // 0x70
...
public:
	...
	bool operator!=(const ZUIEmoteSelectorNavigationEntity_SActionSelectorDataCache& p_Other) const { return !(*this == p_Other); }

	TArray<ZUIEmoteSelectorNavigationEntity_SActionSelectorSlotDisplayInfo> mainslots; // 0x0
	TArray<ZUIEmoteSelectorNavigationEntity_SActionSelectorSlotDisplayInfo> otherslots; // 0x18
};
...
public:
	...
	bool operator!=(const ZUIEmoteSelectorNavigationEntity_SActionSelectorSlotDisplayInfoSlim& p_Other) const { return !(*this == p_Other); }
...
public:
	...
	bool operator!=(const ZUIEmoteSelectorNavigationEntity_SActionSelectorInvokeData& p_Other) const { return !(*this == p_Other); }

	TArray<ZUIEmoteSelectorNavigationEntity_SActionSelectorSlotDisplayInfoSlim> mainslotsSlim; // 0x0
	int32 otherslotsCount; // 0x18
	int32 selectedIndex; // 0x1C
	bool isActionInventory; // 0x20
	uint8_t _pad21[7] {};
...
// Size: 0x4
enum class ZUIGlobalSubtitleCondition_ESpatialType
{
	Any = 0,
	Audio2D = 1,
	Volumetric = 2,
...
public:
	...
	bool operator!=(const ZUIMapLegendDataProvider_SLegendTracker& p_Other) const { return !(*this == p_Other); }

	ZString ControlName; // 0x0
};
...
public:
	...
	bool operator!=(const ZUIMapLegendDataProvider_SData& p_Other) const { return !(*this == p_Other); }

	ZString Location; // 0x0
	ZString lstrLocation; // 0x10
	TArray<ZUIMapLegendDataProvider_SLegendTracker> LegendTrackers; // 0x20
};
...
// Size: 0x4
enum class ZUISubtitleSpeakerCinematicModeOverrideEntity_EMode
{
	Gameplay = 0,
	Cinematic = 1,
};
...
// Size: 0x4
enum class ZUISubtitleSpeakerDefaultIconEntity_EEmitterType
{
	Audio2D = 1,
	Volumetric = 2,
};
