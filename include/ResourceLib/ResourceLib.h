...
extern "C"
{
	 ...
	 */
	RESOURCELIB_API JsonString* ZHM_TARGET_FUNC(GameStructToJson)(const char* p_StructureType, const void* p_Structure, size_t p_Size);
	 ...
	 */
	RESOURCELIB_API bool ZHM_TARGET_FUNC(JsonToGameStruct)(const char* p_StructureType, const char* p_JsonStr, size_t p_JsonStrLength, void* p_TargetMemory, size_t p_TargetMemorySize);
	 ...
	 */
	RESOURCELIB_API void ZHM_TARGET_FUNC(FreeJsonString)(JsonString* p_JsonString);
	 ...
	 */
	RESOURCELIB_API StringView ZHM_TARGET_FUNC(GetPropertyName)(uint32_t p_PropertyId);
